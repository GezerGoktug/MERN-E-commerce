...
import { useAskQuestionToAiChatbotMutation } from '../../../../application/use-cases/ai.use-cases'
import { AiOutlineLoading3Quarters } from 'react-icons/ai'
import { AxiosError } from 'axios'
import { type ExtendedProductType } from '../../../../domain/entities/product.entity'
import { Link } from 'react-router-dom'
import { useIsProductsInFavQuery } from '../../../../application/use-cases/product.use-cases'
import { isAccess } from '../../../../application/store/auth/hooks'
import { useHandleFavouriteMutation } from '../../../../application/use-cases/product.use-cases'
import { getSize } from '../../../../domain/helpers/getSize'
import { type MessageType } from '../../../../domain/entities/ai.entity'
import { useGetAiConversationThreadByThreadIdQuery } from '../../../../application/use-cases/ai.use-cases'
                    ...
                    <div className={styles.support_chatbot_panel_top}>
                        <div className={styles.support_chatbot_panel_top_left}>
                            <div className={styles.support_chatbot_panel_top_left_avatar}>
                                ...
                                <img src={`${import.meta.env.BASE_URL}agent.avif`} alt="agent" />
                            </div>
                                ...
                                messages.map((msg, i) => (
                                    ...
                                    >
                                        <div className={clsx(styles.support_chatbot_panel_message, { [styles.is_my_message]: msg.type === "human" })}>
                                            {msg.type === "ai" && <img src={`${import.meta.env.BASE_URL}agent.avif`} alt="" />}
                                            <p>{msg.message}</p>
                                        </div>
                                        {
                                            msg.isFirstMessage &&
                                ...
                                isPending && (
                                    ...
                                    >
                                        <div className={styles.support_chatbot_panel_skeleton_message}>
                                            <img src={`${import.meta.env.BASE_URL}agent.avif`} alt="" />
